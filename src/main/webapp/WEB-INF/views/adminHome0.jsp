...
<html>
<head>
<style type="text/css">@import url("<spring:url value="/css/admin.css"/>");</style>
...
<body>
			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="navbar-collapse-3">
					<ul class="nav navbar-nav navbar-left">
						<li><a href="<spring:url value='/addCar' />">Add Car</a></li>
						<li><a href="<spring:url value='/addCarType' />">Add Type</a></li>
						<li><a href="<spring:url value='/admin/addUser' />">Add User</a></li>
						...
						<li><a class="btn btn-default btn-outline btn-circle collapsed"
							...
							aria-expanded="false" aria-controls="nav-collapse3">Search</a></li>
					</ul>
		...
		<div class="panel-body">
			<c:forEach items="${carList}" var="car">
				...
				<img src="<c:url value="/resource/images/${car.name}.png"></c:url>" alt="image"  style = "width:30%"/>
				</div>
