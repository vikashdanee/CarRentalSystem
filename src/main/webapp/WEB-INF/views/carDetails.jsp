...
<body>
<form:form modelAttribute="car" action="/editCar" method="post" enctype="multipart/form-data">
    <table>
        <tr>
        ...
        <tr>
            <td colspan="2"><label>Car Details:</label> <form:input path="id" type="hidden"></form:input></td>
        </tr>
        <tr>
